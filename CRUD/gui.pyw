...
class Aplication():
    def __init__(self):
        ...
        self.listbox_name = tk.Listbox(miFrame,width = 42,listvariable = self.elements_name,selectmode = tk.EXTENDED)
        self.listbox_name.grid(row = 3,column = 0)
        self.listbox_price = tk.Listbox(miFrame,width = 42,listvariable = self.elements_price)
